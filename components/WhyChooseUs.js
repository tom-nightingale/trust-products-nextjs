        ...
        <div className="p-4 bg-gray-100/50">
            ...
            <div className="mx-auto max-w-screen-2xl">
                ...
                <div className="relative p-4 text-center md:w-1/3 md:p-8 lg:p-16 after:absolute after:right-0 after:top-[50%] md:after:w-[1px] after:h-1/2 after:transform after:-translate-y-1/2 after:bg-black/10">           
                    ...
                    <p className="text-sm">Our reputation has been hard won and is much cherished. Our commitment to you is that we intend to provide the very best products at competitive price levels in shortest delivery times.</p>
                </div>    
