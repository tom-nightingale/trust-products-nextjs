...
export default function mobileMenu({ navItems }) {
    ...
    return (
        <>
            ...
            {/* Mobile Menu */}
            <div open={open} className={`fixed top-0 left-0 w-full h-full p-4 transition-all duration-200 bg-white ${open ? 'opacity-100 z-40' : 'opacity-0 -z-10'}`}>
                ...
                <motion.div variants={container} initial="hidden" animate={open ? 'show' : ''}>
                    ...
                    <motion.div className="text-center" variants={listItem}>
                        <a className="transition-all duration-200" variants={listItem} href="tel:01773719239">Tel: <span className="font-bold">01773 719 239</span></a>                    
                    </motion.div>
